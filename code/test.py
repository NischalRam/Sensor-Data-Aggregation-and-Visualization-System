...
import ujson
from your_main_script import api_response  # Replace 'your_main_script' with the actual name of your script
...
from your_module_or_file import api_response, history_stack  # Import your actual module or file
